...
xyouts, .93, .45, 'f='+string(A[0],format='(f6.2)')+'e!E'+string(A[1], format='(f8.4)')+'t!N+'+$
  string(A[2], format='(f6.2)'), color=fsc_color('Red'), charsize=2, charthick=2, alignment=1, /normal
